...
enum iso_file_type
{
  iso_file_hidden   = 1,  /* File is Hidden if this bit is 1 */
  iso_file_isdir    = 2,  /* Entry is a Directory if this bit is 1 */
  iso_file_associat = 4,  /* Entry is an Associated file is this bit is 1 */
  iso_file_useext   = 8,  /* Information is structured according to the extended attribute record if this bit is 1 */
  iso_file_useperm  = 16, /* Permissions are specified in the extended attribute record if this bit is 1 */
  iso_file_multidir = 128 /* File has more than one directory record if this bit is 1 */
};
...
struct iso_prim_voldesc
{
  ...
  uint32_t   le_opath_table_blk;  /* LittleEndian optional path table block index */
